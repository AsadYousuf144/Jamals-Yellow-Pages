...
{
    public partial class Trade2 : MetroFramework.Forms.MetroForm
    {
        public Trade2()
        {
            InitializeComponent();
        ...
        private void Trade2_Load(object sender, EventArgs e)
        {
        ...
        public void calls()
        {
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    con.Open();
                    SqlCommand command = new SqlCommand("select mission,name,status, mobile,ad1,city,email1,url,phone_code,poff_1,fax1 from [Trade] where [country] = '" + label7.Text + "'  ", con);
        ...
        public void calls3()
        {
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    con.Open();
                    SqlCommand command = new SqlCommand("select mission,name,status, mobile,ad1,city,email1,url,phone_code,poff_1,fax1 from [Trade] where [country] = '" + label7.Text + "' and city = '" + metroComboBox1.Text + "' ", con);
                    reader = command.ExecuteReader();
                    calls2();
                    con.Close();
                }
        ...
        private void Trade2_FormClosing(object sender, FormClosingEventArgs e)
        {

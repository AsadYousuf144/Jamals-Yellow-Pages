...
namespace Jamals_Yellow_Pages
{
    ...
    public partial class Foreign : MetroFramework.Forms.MetroForm
    {
        public Foreign()
        {
            InitializeComponent();
        ...
        string c = "abc";
        private void Foreign_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("select distinct[company_1] from [Foreign]", con);
        ...
        public void calls123() {
            ...
            try
            {
                ...
                {
                    con.Open();
                    command = new SqlCommand("select [company_1],person_con,status, ad1,ad2,cityname,e_mail,web_cust,phone_1,phone_2,phone_3,phone_4,telefax,un_no from [Foreign] where [company_1] = '" + c + "' and cityname = '"+ metroComboBox1.Text +"' ", con);
        ...
        public void calls()
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    command = new SqlCommand("select [company_1],person_con,status, ad1,ad2,cityname,e_mail,web_cust,phone_1,phone_2,phone_3,phone_4,telefax,un_no from [Foreign] where [company_1] = '" + metroTextBox1.Text + "' ", con);
                    reader = command.ExecuteReader();             
        ...
        private void Foreign_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void metroButton3_Click_1(object sender, EventArgs e)
        {
            ...
            {
                label7.Text = "Wrong input. Foreign Mission is required..!";
                panel1.Controls.Clear();
                c = "";

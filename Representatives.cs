...
{
    public partial class Representatives : MetroFramework.Forms.MetroForm
    {
        ...
        protected void l123_Click(object sender, EventArgs e)
        {
            ...
            Text12 = lbl.Text;
            Representatives2 r2 = new Representatives2();
            r2.Show();
            this.Hide();
            // MessageBox.Show(cName.ToString());
            //lbl.Font = new Font(lbl.Font.Name, lbl.Font.SizeInPoints, FontStyle.Regular);
        ...
        private void Representatives_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand command12 = new SqlCommand("select distinct[country] from [Representatives]", con);
            SqlDataReader dr = command12.ExecuteReader();
            if (dr.HasRows == true)
            {
                while (dr.Read())
        ...
        public void calls()
        {
            ...
            try
            {
                ...
                { 
                    con.Open();
                    command = new SqlCommand("select mission,name,status, mobile,ad1,city,email1,url,phone_code,poff_1,fax1 from [Representatives] where [country] = '" + metroTextBox1.Text + "'  ", con);
        ...
        public void calls123()
        {
            ...
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    con.Open();
                    command = new SqlCommand("select mission,name,status, mobile,ad1,city,email1,url,phone_code,poff_1,fax1 from [Representatives] where [country] = '" + c + "' and city = '" +metroComboBox1.Text+ "' ", con);
                    reader = command.ExecuteReader();
        ...
        public void Catagories()
        {
            ...
            while (reader1.Read())
            {
                ...
                {
                    //a = 5;
                    l123.Location = new Point(5 + d, a-1500);
                   // a = a + 20;
                }
                else {
        ...
        private void calls2()
        {
            try
            {
                ...
                {
                    con.Open();
                    command1 = new SqlCommand("select distinct[country] from [Representatives] order by [country]", con);
        ...
        private void Representatives_FormClosing(object sender, FormClosingEventArgs e)
        {

...
{
    public partial class Representatives2 : MetroFramework.Forms.MetroForm
    {
        public Representatives2()
        {
            InitializeComponent();
        }
        ...
        private void Representatives2_Load(object sender, EventArgs e)
        {
            ...
            label7.Text = Representatives.Text12;
        ...
        public void calls2() {
            ...
            while (reader.Read())
            {
                ...
                l16a.Location = new Point(81, a + 133);
        ...
        public void calls()
        {
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    con.Open();
                    SqlCommand command = new SqlCommand("select mission,name,status, mobile,ad1,city,email1,url,phone_code,poff_1,fax1 from [Representatives] where [country] = '" + label7.Text + "'  ", con);
        ...
        public void calls3()
        {
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    con.Open();
                    SqlCommand command = new SqlCommand("select mission,name,status, mobile,ad1,city,email1,url,phone_code,poff_1,fax1 from [Representatives] where [country] = '" + label7.Text + "' and city = '" + metroComboBox1.Text + "' ", con);
                    reader = command.ExecuteReader();
                    //int b = 55;
                    calls2();
        ...
        private void Representatives2_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Representatives2_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            panel1.Height = 765;
            Bitmap bmp = new Bitmap(713, 1200, panel1.CreateGraphics());
            ...
            e.Graphics.DrawImage(bmp, ((pagearea.Width / 2) - (this.panel1.Width / 2)), this.panel1.Location.Y - 65);
